...
const Postcard = (props) => {
  ...
  return (
    <div className="col-md-3">
      {isLoading && (
        <div className="loading-spinner d-flex justify-content-center align-items-center" style={{ height: "380px" }}>
          <ClipLoader color="#FFD700" size={50} />
        </div>
      )}
      <div
        className={`card my-3 bg-dark text-white ${isLoading ? "d-none" : ""}`} // Hide card content while loading
        style={{
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          <img
            ...
            alt="Indian Currency"
            onLoad={handleImageLoad} // Call handleImageLoad when the image finishes loading
          />
          <div
            style={{
              position: "absolute",
        ...
        <div className="card-body p-3">
          <p style={{ color: "#FFDDC1", fontSize: "0.9rem" }}>📞 {post.mobilenumber}</p>
